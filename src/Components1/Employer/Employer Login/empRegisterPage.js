...
import EmpLoginLogo from './empHeaderLog';
import EmpFooterLog from './empFooterLog';
import { addUserDataAsync } from '../../../features/dataSlice';
...
const EmpRegistration = () => {
 ...
 <Button as={Link} to="/logins" style={{backgroundColor:'maroon',marginTop:'20px',border:'none',marginBottom:'7px'}}>Back</Button>
     ...
     <Row>
      ...
      <Button variant="primary" type="submit" className='mt-2 mb-2' style={{backgroundColor:'#2B358C',border:'none'}}>Submit</Button>
    </Form>
        </Col>
...
centered>
  ...
  <Modal.Footer>
    <Button variant="secondary" as={Link} to="/employerlogin">
      Proceed
    </Button>
  </Modal.Footer>
</Modal>
